const SettingsApp = (() => {
  ...
  const setupEventListeners = () => {
    document
      .getElementById("saveProfileSettingsBtn")
      ?.addEventListener("click", saveProfileSettings);
    document
      .getElementById("loadProfileSettingsBtn")
      ?.addEventListener("click", loadProfileSettings);
    document
      .getElementById("logoUploadInput")
      ?.addEventListener("change", uploadLogoFromSettings);
    ...
    document.querySelectorAll(".wallpaper-preview").forEach((preview) => {
      preview.addEventListener("click", () => {
        ...
        document
          .querySelectorAll(".wallpaper-preview")
  ...
  const loadProfileSettings = () => {
    ...
    document.getElementById("profileBankAccount").value =
      profile.bankAccount || "";
    ...
    if (logoPreview) {
      logoPreview.src =
        profile.logoData || "assets/icons/image-placeholder.svg";
    }
